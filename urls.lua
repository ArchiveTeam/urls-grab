...
print(string.gsub(url, "([0-9a-zA-Z%-_%%]+)", ""), string.gsub(parenturl, "([0-9a-zA-Z%-_%%]+)", ""))
        if string.match(url, "^https?://([^/]+)") == string.match(parenturl, "^https?://([^/]+)")
          and string.gsub(url, "([0-9a-zA-Z%-_%%]+)", "") == string.gsub(parenturl, "([0-9a-zA-Z%-_%%]+)", "") then
          skip_extension = true
        end
      end
