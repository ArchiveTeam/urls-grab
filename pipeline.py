...
project = Project(
    title = 'URLs',
    project_html = '''
    <img class="project-logo" alt="logo" src="https://wiki.archiveteam.org/images/thumb/7/77/ArchiveTeamWarriorLogo.png/235px-ArchiveTeamWarriorLogo.png" height="50px"/>
